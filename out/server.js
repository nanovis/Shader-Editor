        ...
        else
        {
            ...
            fs.writeFile(__dirname+'/../main.cpp',code,function(err){
              ...
              cmd.run("cd "+__dirname+"/../"+" && make",function(err,data)
              {
                  ...
                  {
                      res.render(__dirname+"/new_template.html",{wgsl_code:req.body.code,texture1:req.body.texture1,texture2:req.body.texture2,texture3:req.body.texture3,texture4:req.body.texture4})
                  }
              })
          })
        }
